...
--[[
    Notes:
    - theme requires its own at_screen_connect function
    - 
]]
...
local my_theme = themes[1]

-- set the theme
beautiful.init(config_dir .. theme_dir .. my_theme .. "/theme.lua")

local tag_count = beautiful.tag_count
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,		  },            "w",     function () awful.spawn("rofi -show window -theme " .. os.getenv("HOME") .. "/.config/rofi/launchers/misc/blurry.rasi") end,
              {description = "run prompt", group = "launcher"}),
    awful.key({ modkey		  },            "r",     function () awful.spawn("rofi -show run -theme " .. os.getenv("HOME") .. "/.config/rofi/launchers/misc/blurry.rasi") end,
              {description = "run prompt", group = "launcher"}),
...
client.connect_signal("request::titlebars", function (c) beautiful.build_custom_titlebar(c) end)
